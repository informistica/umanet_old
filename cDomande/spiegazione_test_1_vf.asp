...
<head>
   ...
   <title>Spiegazione Quiz Vero/Falso</title>   
...
'homesito="/anno_2010-2011_ITC/ECDL"
  ...
  stampa=Request.QueryString("stampa")
...
" WHERE  Domande.Segnalata=0 and Domande.Lingua='"&Lingua&"' and   ID_Predomanda not in (Select Id_Predomanda from Domande WHERE Domande.Id_predomanda<>0 and Id_Mod='" &Modulo  & "') " &_
	" GROUP BY Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img,Domande.Img,Domande.Id_Sottoparagrafo" 
...
" WHERE  Domande.Segnalata=0 and Domande.Lingua='"&Lingua&"' and  Domande.Id_predomanda<>0 and ID_Predomanda not in (Select Id_Predomanda from Domande WHERE  Id_Stud='"&Session("CodiceAllievo")&"') and Id_Mod='" &Modulo  & "') " &_
	" GROUP BY Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img, Domande.Img,Domande.Id_Sottoparagrafo" 
...
" GROUP BY Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod, Domande.Tipo, Domande.In_Quiz, Domande.Cartella, Domande.Id_Predomanda, Domande.Id_Sottoparagrafo, Domande.Multiple, Domande.VF, Domande.Img, Domande.Img,Domande.Id_Sottoparagrafo"
...
' 'Definzione codice SQl della query per ricercare le domande del paragrafo 
   ...
   if (Session("Admin")=True) or (Privato=0) then  'se vero visualizzo tutte le domande del PARAGRAFO altrimenti solo quelle dello       studente loggato  
	...
	QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img,Domande.Id_Sottoparagrafo" &_
	costQuerySQL2 &_
	" HAVING Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0  AND Domande.VF=1" &_   
	" ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
   else
	QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img, Domande.Img,Domande.Id_Sottoparagrafo" &_
	costQuerySQL22 &_
	" HAVING Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 AND Domande.VF=1 and Domande.Id_Stud='"& Session("CodiceAllievo")& "'" &_
	"' ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
   end if 
  ...
  if (Session("Admin")=True) or (Privato=0) then  'se vero visualizzo tutte le domande del MODULO altrimenti solo quelle dello       studente loggato  
	...
	QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img,Domande.Id_Sottoparagrafo" &_
	costQuerySQL1 &_
" HAVING Moduli.ID_Mod='" & Modulo & "' AND Domande.In_Quiz<>0 AND Domande.VF=1" &_ 
" ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
 else
   QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img,Domande.Id_Sottoparagrafo" &_
	costQuerySQL11 &_
" HAVING Moduli.ID_Mod='" & Modulo & "' AND Domande.In_Quiz<>0 AND Domande.VF=1 and Domande.Id_Stud='"& Session("CodiceAllievo") & "'" &_
"' ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
 end if
  ...
  ' sottoparagrafo
		  ...
		  if (Session("Admin")=True) or (Privato=0) then  'se vero visualizzo tutte le domande del MODULO altrimenti solo quelle dello       studente loggato  		
			QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda,Domande.Id_Sottoparagrafo, Domande.Multiple, Domande.VF, Domande.Img" &_
			costQuerySQL3 &_
		" HAVING Moduli.ID_Mod='" & Modulo & "'and  Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 and Domande.VF=1 " &_ 
		" ORDER BY  Domande.Multiple, Domande.VF, Domande.Img;"
		 else
		   QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda,Domande.Id_Sottoparagrafo, Domande.Multiple, Domande.VF, Domande.Img" &_
			costQuerySQL33 &_
		" HAVING  Moduli.ID_Mod='" & Modulo & "' and Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 and Domande.VF=1 and Domande.Id_Stud='"& Session("CodiceAllievo") & "'" &_
		"' ORDER BY  Domande.Multiple, Domande.VF, Domande.Img;"
		 end if
					 ...
					 set rsTabellaSotto=ConnessioneDB.execute (querySqlSotto)
					  ' response.write(querySqlSotto)	
					   Sottoparagrafo=rsTabellaSotto("Id_Sottoparagrafo")
						...
						%>
						<b><center> <font size="+2"><%=rsTabellaSotto("Titolo")%></font> </center></b> 
					 <%end if%>
				<%end if%>  
...
%>
 ...
 <table  class="table table-hover table-nomargin table-condensed table-bordered">
        ...
        <tr><th  class='hidden-350' width="15%">
           <%
		 '  if stato<>0 then
		'    response.write(rsTabella("Titolo")&": ")
		'  end if
		  response.write("<b>InQuiz:"&rsTabella("In_Quiz")&"</b>;<b>N:"&rsTabella("CodiceDomanda")&"</b>")
		  %></th>
 ...
 %>
				...
				<div class="row-fluid">
				  <div class="span12">
				    <div class="box">
                   <center>
                   <span class="btn"><%=k%> Domande</span>
				   
				   <form name="dati" method="POST" action="7_stampa_schede_domande.asp?tipo=Vero/Falso&tutto=1&CodiceAllievo=<%=CodiceAllievo%>&Modulo=<%=modulo%>&Capitolo=<%=capitolo%>&Paragrafo=<%=paragrafo%>&CodiceTest=<%=CodiceTest%>&Cartella=<%=cartella%>&QuerySQL=<%=QuerySQL%>&Lingua=<%=Lingua%>";>
                                <input type="hidden" name="txtSQL" value="<%=QueryTuttoCap%>">
                                <input type="submit" class="btn" value="Stampa domande" >
                                  <img src="../../img/printer.jpg" title="Stampa questa scheda">
                                </form>	
								<% if session("admin")=true then%>
								<a href="8_esporta_domande_xml.asp?tipo=Vero/Falso&tutto=1&CodiceAllievo=<%=CodiceAllievo%>&Modulo=<%=modulo%>&Capitolo=<%=capitolo%>&Paragrafo=<%=paragrafo%>&CodiceTest=<%=CodiceTest%>&Cartella=<%=cartella%>&QuerySQL=<%=QuerySQL%>&Lingua=<%=Lingua%>"><input type="button" value="Esporta file xml"> </a>
								<br><br>
								<a href="8_esporta_domande_xls.asp?tipo=Vero/Falso&tutto=1&CodiceAllievo=<%=CodiceAllievo%>&Modulo=<%=modulo%>&Capitolo=<%=capitolo%>&Paragrafo=<%=paragrafo%>&CodiceTest=<%=CodiceTest%>&Cartella=<%=cartella%>&QuerySQL=<%=QuerySQL%>&Lingua=<%=Lingua%>"><input type="button" value="Esporta file xls -> kahoot"> </a>

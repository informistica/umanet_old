...
<head>
   ...
   <title>Spiegazione Quiz Singola</title>   
...
' 'Definzione codice SQl della query per ricercare le domande del paragrafo 
   ...
   if (Session("Admin")=True) or (Privato=0) then  'se vero visualizzo tutte le domande del PARAGRAFO altrimenti solo quelle dello       studente loggato  
	...
	QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.Risposta1,Domande.Risposta2,Domande.Risposta3,Domande.Risposta4, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img" &_
	costQuerySQL2 &_
	" HAVING Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 and Domande.VF=0 and Domande.Multiple=0   " &_   
	" ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
   else
	QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.Risposta1,Domande.Risposta2,Domande.Risposta3,Domande.Risposta4, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img" &_
	costQuerySQL22 &_
	" HAVING Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 and Domande.VF=0 and Domande.Multiple=0 and Domande.Id_Stud='"& Session("CodiceAllievo")& "'" &_
	"' ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
   end if 
  ...
  if (Session("Admin")=True) or (Privato=0) then  'se vero visualizzo tutte le domande del MODULO altrimenti solo quelle dello       studente loggato  
	...
	QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.Risposta1,Domande.Risposta2,Domande.Risposta3,Domande.Risposta4, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img" &_
	costQuerySQL1 &_
" HAVING Moduli.ID_Mod='" & Modulo & "' AND Domande.In_Quiz<>0 and Domande.VF=0 and Domande.Multiple=0" &_ 
" ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
 else
   QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.Risposta1,Domande.Risposta2,Domande.Risposta3,Domande.Risposta4, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda, Domande.Multiple, Domande.VF, Domande.Img" &_
	costQuerySQL11 &_
" HAVING Moduli.ID_Mod='" & Modulo & "' AND Domande.In_Quiz<>0 and Domande.VF=0 and Domande.Multiple=0 and Domande.Id_Stud='"& Session("CodiceAllievo") & "'" &_
"' ORDER BY Paragrafi.ID_Paragrafo,Domande.VF,Domande.Multiple;"
 end if
  ...
  ' sottoparagrafo
		  ...
		  if (Session("Admin")=True) or (Privato=0) then  'se vero visualizzo tutte le domande del MODULO altrimenti solo quelle dello       studente loggato  		
			QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.Risposta1,Domande.Risposta2,Domande.Risposta3,Domande.Risposta4, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Cartella,Domande.Id_Predomanda,Domande.Id_Sottoparagrafo, Domande.Multiple, Domande.VF, Domande.Img" &_
			costQuerySQL3 &_
		" HAVING Moduli.ID_Mod='" & Modulo & "'and  Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 and Domande.VF=0 and Domande.Multiple=0 " &_ 
		" ORDER BY Domande.Multiple, Domande.VF, Domande.Img;"
		   ...
		   QuerySQL="SELECT Paragrafi.Titolo, Paragrafi.ID_Paragrafo, Allievi.Cognome,Allievi.Nome, Domande.Quesito, Domande.RispostaEsatta, Domande.Risposta1,Domande.Risposta2,Domande.Risposta3,Domande.Risposta4, Domande.CodiceDomanda, Moduli.ID_Mod,Domande.Tipo,Domande.In_Quiz,Domande.Id_Stud,Domande.Cartella,Domande.Id_Predomanda,Domande.Id_Sottoparagrafo, Domande.Multiple, Domande.VF, Domande.Img" &_
			costQuerySQL33 &_
		" HAVING  Moduli.ID_Mod='" & Modulo & "' and Paragrafi.ID_Paragrafo='" & Codice_Test & "' AND Domande.In_Quiz<>0 and Domande.VF=0 and Domande.Multiple=0 and Domande.Id_Stud='"& Session("CodiceAllievo") & "'" &_
		"' ORDER BY Domande.Multiple, Domande.VF, Domande.Img;"
		 end if
 ...
 %>
				...
				<div class="row-fluid">
				  <div class="span12">
				   ...
				   <form name="dati" method="POST" action="7_stampa_schede_domande.asp?tipo=risposta chiusa singola&tutto=1&CodiceAllievo=<%=CodiceAllievo%>&Modulo=<%=modulo%>&Capitolo=<%=capitolo%>&Paragrafo=<%=paragrafo%>&CodiceTest=<%=CodiceTest%>&Cartella=<%=cartella%>&QuerySQL=<%=QuerySQL%>&Lingua=<%=Lingua%>";>
								...
								<% if session("admin")=true then%>
				<a href="8_esporta_domande_xml.asp?tipo=risposta chiusa singola&tutto=1&CodiceAllievo=<%=CodiceAllievo%>&Modulo=<%=modulo%>&Capitolo=<%=capitolo%>&Paragrafo=<%=paragrafo%>&CodiceTest=<%=CodiceTest%>&Cartella=<%=cartella%>&QuerySQL=<%=QuerySQL%>&Lingua=<%=Lingua%>"><input type="button" value="Esporta file xml"> </a>
						<%end if%>

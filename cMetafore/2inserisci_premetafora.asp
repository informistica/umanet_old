...
<head>
   ...
   <title>Inserisci preMetafora</title>   
	...
	<div class="container-fluid" id="content">
	  ...
	  <div class="container-fluid">
				<div class="page-header">               
					<div class="pull-left">
						<h1> <i class="icon-comments"></i>Inserisci metafore</h1> 
				...
				<div class="row-fluid">
				  ...
				  <% if num<>"" then %>
<form method="POST" name="dati" class="form-vertical" action="2inserisci_premetafora1.asp?Segnalibro=<%=Segnalibro%>&BoxApro=<%=BoxApro%>&by_UECDL=<%=by_UECDL%>&Tipo=<%=Tipo%>&Cartella=<%=Cartella%>&Num=<%=Num%>&CodiceTest=<%=CodiceTest%>&Capitolo=<%=Capitolo%>&Paragrafo=<%=Paragrafo%>&Modulo=<%=Modulo%>&TitoloParagrafo=<%=TitoloParagrafo%>&Scadenza=<%=Scadenza%>&Sottoparagrafo=<%=Sottoparagrafo%>&CodiceSottopar=<%=CodiceSottopar%>&iddiv=<%=iddiv%>" > <!-- Alla pressione del bottone INVIA il form chiama la pagina che verifica il login accedendo al data base specificato dalla stringa di connessione-->

		
		 
		 <br>
		  <b><h5>Inserisci metafore </h5></b>

...
<%    
 ...
 Select case CodiceTest
   Case Cartella&"_U_2_3" 		
		   ...
		   Segnalata=Request("txtSegnalata")
		   if strcomp(Segnalata,"true")=0 then
		     segnalata=1
		   else
		     segnalata=0
		   end if
	...
	'response.write(CodiceTest)
		 ...
		 Case Cartella&"_U_2_3"  
			...
			if daSimulazione<>"" then '
			  QuerySQL ="UPDATE M_Topolino SET Topolino = '" & Topolino & "', Formaggio= '" & Formaggio & "',Fame= '" & Fame & "',Labirinto= '" & Labirinto & "', Strada= '" & Strada & "', Strada_OK= '" & Strada_OK & "', Strada_KO = '" & Strada_KO & "', Testata = '" & Testata & "',Distanza = '" & Distanza & "' WHERE CodiceMetafora =" &ID&";"
			else
		  QuerySQL ="UPDATE M_Topolino SET Topolino = '" & Topolino & "', Formaggio= '" & Formaggio & "',Fame= '" & Fame & "',Labirinto= '" & Labirinto & "', Strada= '" & Strada & "', Strada_OK= '" & Strada_OK & "', Strada_KO = '" & Strada_KO & "', Testata = '" & Testata & "',Distanza = '" & Distanza & "',Voto = '" & voto & "', Data='" & DATA & "', Segnalata=" & Segnalata & "  WHERE CodiceMetafora =" &ID&";"
		   ...
		   QuerySQL ="UPDATE M_Topolino SET Topolino = '" & Topolino & "', Formaggio= '" & Formaggio & "',Fame= '" & Fame & "',Labirinto= '" & Labirinto & "', Strada= '" & Strada & "', Strada_OK= '" & Strada_OK & "', Strada_KO = '" & Strada_KO & "', Testata = '" & Testata & "'  WHERE CodiceMetafora =" &ID&";" 
			else
		...
		Case Cartella&"_U_2_5" 
		 ...
		 if (session("Admin")=True)  then 
			 	if daSimulazione<>"" then ' mancona dei valori quindi qurey semplificata
				 QuerySQL ="UPDATE M_Navigazione SET Autista = '" & Autista & "', Destinazione= '" & Destinazione & "',Carburante= '" & Carburante & "',Luogo= '" & Luogo & "', Strada= '" & Strada & "', Strada_OK= '" & Strada_OK & "', Strada_KO = '" & Strada_KO & "', Cespugli = '" & Cespugli & "',Lupo = '" & Lupo & "',Cestino = '" & Cestino & "'  WHERE CodiceMetafora =" &ID&";"	
				else
...
'	'
if daSimulazione<>"" then
' non tocco il file della spiegazione
else
...
'response.write(url)
	...
	Response.Write "Modifica effettuata correttamente! "
	Else

...
QuerySQL="SELECT * FROM MODULO_PARAGRAFO_FRASI1 Where CodiceAllievo='"&CodiceAllievo&"' and ID_Mod<>'6C' AND  Cartella = '" & Cartella &"';"  

'response.write("<br><br><br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"&QuerySQL&"<br>")
	...
	<div class="container-fluid" id="content">
	  ...
	  <div class="container-fluid">
				<div class="page-header">               
					<div class="pull-left">
						<h1> <i class="icon-comments"></i>Recupero frasi</h1> 
...
<%end if %>
 ...
 <div class="immagini" style="height:auto; width:auto; border:none;" > 
  <form name="dati" class="form-vertical" method="POST"  action="2inserisci_valutazioni_frasi1.asp?NumRec=<%=i%>&Paragrafo=<%=TitoloParagrafo%>&Cartella=<%=Cartella%>&Modulo=<%=Modulo%>" >
...
if rsTabellaNew("Img")=1 then%>
 ...
 <%     QuerySQL1="Select * from Frasi_Img where Id_Frase="& rsTabellaNew("CodiceFrase")&";"
      ...
      <% nome=right(rsTabella1("Nome"),len(rsTabella1("Nome"))- instr(ucase(rsTabella1("Nome")),"C:\FAKEPATH\"))
       ...
       <p align="center">
        <%if instr(rsTabella1("Url"),"tp://")<>0 then ' nb è voluto il tp:// invece di https:// perchp altrimenti essendo all'inizio restituisce 0 che è come se non fosse presente%>
         <img src="<%=rsTabella1("Url")%>" border="1"> <br>
       <%else

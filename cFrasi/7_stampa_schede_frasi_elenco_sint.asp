...
dim sAns
 ...
 ' sAns = Replace(sAns, "&#242;","o'") '�
  ...
  sAns = Replace(sAns, "<script>", "&lt;script&gt;") 
  'sAns = Replace(sAns, ">", "&gt;") 
  ...
  if urlRisp<>"" then
		 ...
		 response.write("<span style='margin-top:-100px'><a href='"& rsTabella1("Url") &"' target='_blank'>apri pagina web</a></span><br><br>")
		  ...
		  %>
	          <% else%>
<br><center>
		           <img class="img-responsive" src="<%=urlimg%>" border="1" ></center> <br>
                <%end if%>

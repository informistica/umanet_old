...
%>
   ...
   Tipo=Request("Tipo") ' tipo di domanda 0 normale 1 estesa
   StringaConnessione= Request.Cookies("Dati")("StrConn")
   prefrase=Request("prefrase") ' serve per capire il chiamante e quindi sapere se alla fine devo redirectare ad home_ver o home_app
    ID_Prefrase=Request("ID_Prefrase") ' serve per controllare se � gi� stata inserita
   by_UECDL=Request("by_UECDL")
  ...
  ' CodiceAllievo = Request.Cookies("Dati")("CodiceAllievo")
   ...
   Capitolo=Request("Capitolo")
	...
	'DataTest = Now()
	   ...
	   Chi = Request.Form("txtQuesito")
	   Chi = Replace(Chi, Chr(34), "'")
	   Chi=  Replace(Chi,"'","''")
  	   Sintesi= Request.Form("txtEncode")

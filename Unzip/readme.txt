// minidesign-pclzip upload&unzip 
// 05/05/2007
// --------------------------------------------------------------------------------
// Il mio piccolo script usa la libreria Php PclZip  
// per estrarre i file da un archivio caricato sul
// server.
// Il Software è fornito "COSÌ COM'È". L'AUTORE NON OFFRE 
// ALCUNA GARANZIA, ESPRESSA O IMPLICITA, IVI COMPRESE, MA
// SENZA LIMITAZIONI, LE GARANZIE IMPLICITE DI NON-VIOLAZIONE,
// COMMERCIABILITÀ E IDONEITÀ DEL PRODOTTO A UNO SPECIFICO 
// SCOPO, IN RELAZIONE AL SOFTWARE O AL SUO UTILIZZO E ALLA SUA
// OPERATIVITÀ, SINGOLARMENTE O IN UNIONE CON ALTRI PRODOTTI.
// L'AUTORE DECLINA OGNI RESPONSABILITÀ PER DANNI SPECIALI, 
// INDIRETTI, ACCIDENTALI O CONSEQUENZIALI (IVI COMPRESI, MA 
// SENZA LIMITAZIONI, L'APPROVVIGIONAMENTO DI BENI O SERVIZI 
// SOSTITUTIVI; L'IMPOSSIBILITÀ DI UTILIZZO E LA PERDITA DI DATI 
// O INTROITI; E L'INTERRUZIONE DELL'ATTIVITÀ LAVORATIVA) 
// DERIVANTI IN QUALSIASI MODO DALL'UTILIZZO, DALLA RIPRODUZIONE,
// DALLA MODIFICA E/O DALLA DISTRIBUZIONE DEL SOFTWARE, 
// INDIPENDENTEMENTE DALLA CAUSA E DALL'ORIGINE DELLA 
// RESPONSABILITÀ (OBBLIGHI CONTRATTUALI, ATTI ILLECITI E 
// NEGLIGENZE, STRETTA RESPONSABILITÀ O ALTRO), ANCHE NEI CASI IN
// CUI L'AUTORE ABBIA RICEVUTO NOTIFICA DELL'EVENTUALITÀ DI TALI DANNI.
//
// Lo script segue inoltre la GNU LESSER GENERAL PUBLIC LICENSE
...
// Istruzioni
// -------------------------------------------------------------------------------
// 1 - Tramite ftp carica la cartella "minidesign-pclzip" nella
// directory in cui vuoi che vengano estratti i file. 
// 2 - Carica l'archivio da decomprimere nella cartella 
// "minidesign-pclzip". 
// 3 - Apri con il browser la pagina index.htm, scrivi il nome
// del file nell'apposito form e invia i dati.
// 
// I file saranno estratti nella stessa directory in cui si
// trova la cartella "minidesign-pclzip". 
// 4 - Ora puoi cancellare l'archivio o l'intera cartella "minidesign-pclzip".

...
'					QuerySQL="SELECT Data FROM 3Periodi WHERE Id_Classe='"&id_classe&"' and Iniziale=1"
            ...
            <div class="user">
					...
					<li class='dropdown'>
                        ...
                        <span class="label label-lightred"><%=numMessaggi%></span>
                         ...
                         <% If rsTabellaAvvisiP.BOF=True And rsTabellaAvvisiP.EOF=True then %>
                            ...
                            <li>
                 <a href="../../social/centro_messaggi.asp?DataClaq=<%=DataClaq%>&amp;DataClaq2=<%=DataClaq2%>" class='more-messages'>Vai al centro messaggi <i class="icon-arrow-right"></i></a>
							</li>
						</ul>
				...
				<div class="dropdown">
					...
					<ul class="dropdown-menu pull-right">
						<li>
							<a href="../../social/form_cambia_pwd_new.asp?dividApro=0">Modifica Profilo</a>
						</li>
						 
						<li>
							<a href="../../social/logout.asp">Log out</a>
						</li>
					</ul>
				</div>
			</div>

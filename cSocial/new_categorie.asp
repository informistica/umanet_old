	...
	<div class="container-fluid" id="content">
	  ...
	  <div class="container-fluid">
				<div class="page-header">               
					<div class="pull-left">
						<h1> <i class="icon-comments"></i>Inserisci categorie </h1> 
        ...
        <br><hr>
       <form method="POST" class="form-vertical" name="dati" action="new_categorie1.asp?scegli=<%=scegli%>" >
        
       <span class="alert-info"> 
        <b>Scrivi le categorie (una su ogni riga)</b>  
        </span>
        
        
        
        <textarea name="MyTextArea" rows=8 cols=70 class="input-block-level" placeholder="Nuove categorie" ></textarea> 

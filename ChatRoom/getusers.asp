...
If Trim(strUsername) = "" OR isNull(strUsername) OR IsEmpty(strUsername) Then
	...
	Response.Write(vbCrLf & "alert('Nessun utente trovato, effettua il login!');")
	Response.Write(vbCrLf & "parent.location=""../../../home.asp"";")
	Response.End
End If

If CheckIfBanned(getIP()) Then
	Response.Write(vbCrLf & "alert('Il tuo IP è stato bannato!');")
	Response.Write(vbCrLf & "parent.location=""../../../home.asp"";")
	Response.End
End If
...
For intArrayPass = 1 TO UBound(saryActiveUsers, 2)
	...
	If strcomp(saryActiveUsers(1, intArrayPass), strUsername)=0 Then
...
If blnUserFound = False Then
	...
	Call PostMessage("", saryActiveUsers(1, intArrayPass) & " entrato in chat.", 1)
End If
...
Select Case strAdminCommand
	Case "kick"
		...
		Response.Write(vbCrLf & "alert('Sei stao espulso !');")
		Response.Write(vbCrLf & "parent.location=""../../../home.asp"";")
		Response.End
End Select
...
'Javascript stuff
Response.Write(vbCrLf & "var addUsers = ""<u>Total Users: " & UBound(saryActiveUsers, 2) & "</u><br>"";")
...
For intArrayPass = 1 TO UBound(saryActiveUsers, 2)
	...
	If blnAdmin Then Response.Write("<br><span style=\""font-size:10px;\""><i><a onclick=\""insertText('/kick " & saryActiveUsers(1, intArrayPass) & "')\"" style=\""cursor: hand;\""><u>Kick User</u></a> - <a onclick=\""insertText('/ban " & saryActiveUsers(3, intArrayPass) & "')\"" style=\""cursor: hand;\""><u>Ban IP</u></a></i></span>")

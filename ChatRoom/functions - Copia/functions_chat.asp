...
'strMessage = Replace(strMessage,":;23","a")
'strMessage = Replace(strMessage,":;22","b")
'strMessage = Replace(strMessage,":;21","c>")
	%>
    <!-- #include file = "replace_codici_img.asp" -->
	<%
	' path = "../../../" & Session("cartella") & "/img_social/"& Session("CodiceAllievo") &"/include/replace_codici_img.asp"
	 
	' path=Server.MapPath(homesito)& "/Materie/"&Session("ID_Materia")& "/" & Session("cartella") &"/img_social/"&Session("CodiceAllievo") &"/include/replace_codici_img.asp"
	'path=Server.MapPath("/anno_2012-2013/UECDL")& "/" & Session("cartella") &"/img_social/"&Session("CodiceAllievo") &"/include/replace_codici_img.asp"
...
' MIO CODICE
	...
	else if inStr(strMessage,"Immagini/Rete_di_Immagini/")=0 and inStr(strMessage,"www.")<>0 then
	         strMessage1=strMessage
			 else if (instr(strMessage,"https")=0) and (instr(strMessage,"https")<>0) then

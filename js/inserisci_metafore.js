...
var cartella, CodiceAllievo,CodiceMetafora,Codice_Test,Modulo,Paragrafo;
	...
	switch(tipo) {
	  case 0:	  	
		  ...
		  dati2="&txtTopolino="+txtTopolino+"&txtFormaggio="+txtFormaggio+"&txtFame="+txtFame+"&txtLabirinto="+txtLabirinto+"&txtStrada="+txtStrada+"&txtStrada_OK="+txtStrada_OK+"&txtStrada_KO="+txtStrada_KO+"&txtTestata="+txtTestata+"&txtDistanza="+txtDistanza+"&S1="+textarea;		 
		 break;
	  case 1:
			...
			dati2="&txtAutista="+txtAutista+"&txtAutista="+txtAutista+"&txtDestinazione="+txtDestinazione+"&txtCarburante="+txtCarburante+"&txtLuogo="+txtLuogo+"&txtStrada="+txtStrada+"&txtStrada_OK="+txtStrada_OK+"&txtStrada_KO="+txtStrada_KO+"&txtCespugli="+txtCespugli+"&txtCestino="+txtCestino+"&txtLupo="+txtLupo+"&txtDistanza="+txtDistanza+"&S1="+textarea;
			break;
	  case 2:

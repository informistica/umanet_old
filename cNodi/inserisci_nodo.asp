...
%>
	  ...
	  <div class="container-fluid">
				...
				<div class="row-fluid">
				  <div class="span12">
				    <div class="box">
				      <div class="box-title">
				        <h3> <i class="icon-reorder"></i>  "<%=Capitolo%> : <%=Paragrafo%>"</h3>&nbsp;&nbsp;<i class="icon-question-sign" onclick="visualizza();"></i>
			          </div>
  ...
  <div class="control-group">
		<label for="textfield" class="control-label"><b>Cosa</b></label>
	     	<div class="controls">
		     	<input type="text" name="txtR1Cosa" id="n1" value="?" placeholder="Azione caratterizzante" maxlength="149" class="input-xxlarge">
	    	</div>
    </div>
    <div class="control-group">
		<label for="textfield" class="control-label"><b>Dove</b></label>
	     	<div class="controls">
		     	<input type="text" name="txtR2Dove"  id="n2" value="?"  placeholder="Luogo in cui avviene l'azione" maxlength="149" class="input-xxlarge">
	    	</div>
    </div>
    <div class="control-group">
		<label for="textfield" class="control-label"><b>Quando</b></label>
	     	<div class="controls">
		     	<input type="text" name="txtR3Quando"  id="n3"  value="?" placeholder="Tempo in cui avviene l'azione" maxlength="149" class="input-xxlarge">
	    	</div>
    </div>
     <div class="control-group">
		<label for="textfield" class="control-label"><b>Come</b></label>
	     	<div class="controls">
		     	<input type="text" name="txtR4Come"  id="n4"  value="?" placeholder="Modo in cui viene svolta l'azione" maxlength="149" class="input-xxlarge">
	    	</div>
    </div>
     <div class="control-group">
		<label for="textfield" class="control-label"><b>Perch&egrave;</b></label>
	     	<div class="controls">
		     	<input type="text" name="txtR5Perche"  id="n5"  value="?" placeholder="Motivo per cui viene svolta l'azione" maxlength="149" class="input-xxlarge">
	    	</div>
    </div>
     <div class="control-group">
		<label for="textfield" class="control-label"><b>Quindi</b></label>
	     	<div class="controls">
		     	<input type="text" name="txtREQuindi"  id="n6"  value="?" placeholder="Senso generale dell'azione compiuta" maxlength="149" class="input-xxlarge">
	    	</div>
    </div>
	...
	function visualizza(){
		     ...
		     if (visibili==1) {
				visibili=0;
				 for (i=1;i<7;i++) { document.getElementById('n'+i).value="?";
				 }
			 } else {
			    visibili=1;
				for (i=1;i<7;i++) { document.getElementById('n'+i).value="";

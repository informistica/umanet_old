	...
	<div class="container-fluid" id="content">
	  ...
	  <div class="container-fluid">
				<div class="page-header">               
					<div class="pull-left">
						<h1> <i class="glyphicon-snowflake"></i> Inserisci nodi</h1> 
...
<% else%>
    ...
    <% 
       response.write("Quanti nodi vuoi inserire ?") %></b><br></span>
       <form class="form-vertical" method="POST" form action="1inserisci_prenodo.asp?Segnalibro=<%=Segnalibro%>&BoxApro=<%=BoxApro%>&by_UECDL=<%=by_UECDL%>&Cartella=<%=Cartella%>&Capitolo=<%=Capitolo%>&Paragrafo=<%=Paragrafo%>&Modulo=<%=Modulo%>&TitoloParagrafo=<%=TitoloParagrafo%>" >
       ...
       <span class="alert-info"> 
        ...
        <textarea name="MyTextArea" rows=8 cols=70 class="input-block-level" placeholder="aggiungi di seguito al nodo il $ se &egrave; previsto il caricamento di immagini, aggiungi il # se &egrave; previsto il caricamento di file " ></textarea> 

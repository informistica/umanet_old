       ...
       <b> Risorsa</b> <input type="text" value="<%=rsTabella.fields("URL_O")%>" name="txtURL<%=i%>"  class="input-xlarge">  
		...
		<%
			...
			numdom=rsNum(0)								
											...
											%>
			<br><%=i+1%>.<%=j+1%>)<input type="text"  value="<%=rsTabSottoPar("ID_Sottoparagrafo")%>" name="txtIdSotPar<%=i%>" class="input-xxsmall">  
		...
		if hasSott then
		%><br>
		<%=i+1%>.<%=j+1%>) <input placeholder="Inserisci ID_Sottoparagrafo" type="text"  name="txtIdSotParNew" class="input-xxsmall"> 
		 <input type="text" placeholder="Titolo"    name="txtSotParagrafoNuovo" size="50">Url <input type="text" placeholder="url risorsa"  name="txtSotUrlParagrafoNuovo" size="50">
		 Pos <input type="text" placeholder="posizione" name="txtSotPosPar" size="3" class="input-mini">&nbsp;
...
<%
	...
	rsTabella.movenext%>
 <%loop%><br><b>
  <%=i+1%>) </b>Paragrafo <input type="text" placeholder="Titolo"  value="" name="txtParagrafoNuovo"  size="50">Url <input placeholder="url risorsa" type="text"  value="" name="txtUrlParagrafoNuovo" size="50">

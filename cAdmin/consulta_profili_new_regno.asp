...
<%end if %>
                ...
                <div class="bs-docs-example"> 
                  ...
                  <ul id="myTab2" class="nav nav-tabs">
                                    <li class="active"><a href="#profileR" data-toggle="tab">Regno</a></li>   
                                     <li><a href="#profile16" data-toggle="tab">16Personality</a></li>   
                                    <% if session("Admin")=true then %>                           
                                    <li><a href="#profileMN" data-toggle="tab">MyndSide</a></li>                                    
       								<%end if%>
                            </ul>
                     ...
                     <table class="table table-hover table-nomargin table-bordered dataTable dataTable-fixedcolumn dataTable-scroll-x table-striped" id="tabella"> 
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th><b>Abitanti del Regno</b>   </th>                               
                                  <th title="Punti Aiutante"><b><a href="../../U-ECDL/Risorse/I%20Manager%20della%20tavola%20rotonda/cavalieri_tavola_rotonda/aiutanti.pdf" target="_blank">PA</a></b></th>
                                  <th title="Punti Sfidante"><b><a href="../../U-ECDL/Risorse/I%20Manager%20della%20tavola%20rotonda/cavalieri_tavola_rotonda/sfidanti.pdf" target="_blank">PS</a></b></th>
                                  <th title="Punti Esploratore"><b><a href="../../U-ECDL/Risorse/I%20Manager%20della%20tavola%20rotonda/cavalieri_tavola_rotonda/esploratori.pdf" target="_blank">PE</a></b></th>
                                  <th title="Punti Conservatore"><b><a href="../../U-ECDL/Risorse/I%20Manager%20della%20tavola%20rotonda/cavalieri_tavola_rotonda/conservatori.pdf" target="_blank">PC</a></b></th>
                   ...
                   <% i=0
	url= "../../DB"&Session("DB")&"/Materie/"&Session("ID_Materia") &"/"&classe&"/Profili/thumb" ' vuole il percorso relativo della cartella
    url=Replace(url,"\","/")
   i=0
   test=0
   do while not rsTabella.eof 
     ...
     QuerySQLR="Select * from RisultatiRE where CodiceAllievo='" & rsTabella("CodiceAllievo") & "' and ID_R =(select MAX(ID_R) from RisultatiRE where CodiceAllievo='"& rsTabella("CodiceAllievo") & "');" 
	Set rsTabellaR = ConnessioneDB.Execute(QuerySQLR) 
 
         if not rsTabellaR.eof then
   ...
   %>
                   ...
                   <tr class="<%=riga%>">
                   <td><%=rsTabella("Cognome") & "  " & rsTabella("Nome")%></td>
                   <td><%=rsTabellaR("a")%></td>
                   <td><%=rsTabellaR("b")%></td>
                   <td><%=rsTabellaR("c")%></td>
                   <td><%=rsTabellaR("d")%></td>
  ...
  loop 
  if test=0 then %>
  	<tr><td >Nessun test svolto </td></tr>
  <% end if%>
                ...
                <div class="row-fluid">
                    ...
                    <div class="box box-color box-bordered <%=Session("stile")%>">
								...
								<div class="box-content nopadding">
                     <table class="table table-hover table-nomargin table-bordered dataTable dataTable-fixedcolumn dataTable-scroll-x table-striped" id="tabella1"> 

...
url=Server.MapPath(homesito & "/esportati")&"/"&nome_modulo&".json"
...
'response.write("<br><br>Folder origine:"&folderorigine&"<br>") 

file=""

riga="[{""model"":""courses.module"", ""pk"":"&pk_modulo&","
response.write(riga)
...
riga="""fields"": {""module"":"&pk_modulo&",""title"":"""&rsTabellaPar("Tit")&""",""url"":"""&rsTabellaPar("URL_O")&""", ""order"":"&i&"}},"
response.write(riga)
'file=file&riga
objCreatedFile.WriteLine(riga)
    ...
    if hasSott then
        ...
        Set rsTabellaPrefrasi = ConnessioneDB.Execute(QuerySQL)	
           ...
           ' response.write("140:" & rsTabellaPrefrasi("Estesa")=True)
            ...
            riga="""fields"": {""title"":"""& replacecar(Server.HTMLEncode(rsTabellaPrefrasi("Quesito")))&""",""module"":"&pk_modulo&",""content"":"&pk_paragrafo&",""subcontent"":"& pk_sottoparagrafo&", ""position"":"& position &",""deadline"":"""&deadline &""",""extended"":"""& extended &""",""img"":"""& hasimg &""",""question"":"""& question &"""}},"
            response.write(riga)
            objCreatedFile.WriteLine(riga)
            'file=file&riga

...
' See license info at https://asp-upload.borec.net
'2. I'll be glad if you include <A Href="https://asp-upload.borec.net">Pure ASP file upload</A>
' or similar text link to https://www.motobit.com on the web site using Pure-ASP upload.
...
'This class emulates ASPForm Class of Huge-ASP upload, https://upload.Motobit.cz
...
Class ASPForm
	...
	Private Function CheckRequestProperties
	  ...
	  If LCase(Left(CT, 19)) <> "multipart/form-data" Then 'Content-Type header must be "multipart/form-data"
		...
		'****** Error of IE5.01 - doubbles https header
...
window.close();
  ...
  ' if you want to upload bigger files, please register ScriptUtilities and Huge-ASP upload
	' at https://www.motobit.com/help/scptutl/lc2.htm

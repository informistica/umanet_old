...
doc=Request.Cookies("Dati")("DOC") ' corso docenti
Response.Cookies("Dati")("DOC")=""
ans=Request.Cookies("Dati")("AS") ' anni scorsi
Response.Cookies("Dati")("AS")=""

if (strcomp(pageset,"2")=0) and (strcomp(doc,"1")=0) then
   Response.Redirect("../../home.asp")
else
  if (strcomp(pageset,"2")=0) and  (strcomp(ans,"1")=0) then

									 ...
									 <table class="table table-hover table-nomargin table-bordered dataTable dataTable-fixedcolumn dataTable-scroll-x table-striped"> 
										...
										<thead>
											<tr>
                                                ...
                                                <th title="ApriChat"><b>Invia</b></th>
											</tr>
										</thead>
										<tbody>
										...
										QuerySQL="Select * From Allievi where Id_Classe='"&session("id_classe")&"' order by Cognome, Nome"
										...
										<tr>
                                                ...
                                                <td title="ApriChat"> 
												<input type="checkbox"  name="cb<%=i%>" id="cb<%=i%>" value="<%=i%>" > 
												</td>

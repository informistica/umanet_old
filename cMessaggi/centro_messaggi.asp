  ...
  <div id="main">
    <div class="container-fluid">
      <div class="page-header">
        <div class="pull-left">
          <h3> <i class="icon-comment"></i> Leggi e Consulta Notifiche</h3>
        </div>
      ...
      <div class="breadcrumbs">
        <ul>
          ...
          <li> <a href="#">Consulta Notifiche</a> </li>
        </ul>
        </ul>
      ...
      <div class="row-fluid">
		...
		<div class="alert">
			...
			<strong>Attenzione!</strong> Potresti avere dei problemi con le notifiche antecedenti la data di inizio dell'anno scolastico, in quanto la tua classe è cambiata!
			<br>Per richiedere la cancellazione dei messaggi privati, contatta l'Amministratore di Sistema.
		</div>
          <!-- #include file = "boxmessaggi.asp" -->
        </div>
      </div>
    </div>
